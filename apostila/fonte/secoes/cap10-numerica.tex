...
\programa[ISCO, precessão do periélio em campo forte, deflexão da luz e queda radial.]{codigo/cap10\_geodesicas\_schwarzschild.py}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figuras/cap10_potencial_orbita.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{figuras/cap10_queda_radial.pdf}
...
\programa[Christoffel, Riemann e Ricci de Schwarzschild; Kretschmann; extração exata da ISCO e da precessão.]{codigo/cap10\_schwarzschild\_simbolico.wl}
