...
\programa[Idade do universo, evolução do fator de escala, distâncias cosmológicas e horizontes.]{codigo/cap13\_friedmann.py}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figuras/cap13_friedmann.pdf}
...
\programa[Derivação das equações de Friedmann a partir da métrica FLRW e a solução fechada em $\sinh^{2/3}$.]{codigo/cap13\_friedmann\_simbolico.wl}
