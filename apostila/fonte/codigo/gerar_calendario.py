...
AULAS = {
    ...
    21: (FLU, ["Conservação: continuidade e Euler", "Equações de estado",
               ...
               EXA, POR, EXE, EXT]),
    22: (GRA, ["O princípio da equivalência"]),
    23: (GRA, ["Coordenadas curvilíneas", "Bases coordenadas e bases não coordenadas"]),
    24: (GRA, ["Geodésicas e os símbolos de Christoffel"]),
    25: (GRA, ["Christoffel não é força", "Marés como sinal de curvatura", POR, EXE, EXT]),
