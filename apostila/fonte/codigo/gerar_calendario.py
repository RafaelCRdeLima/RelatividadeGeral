...
AULAS = {
    ...
    4:  (RE, ["A velocidade invariante é única",
              ...
              "Indo além: a rapidez e o fator Doppler"]),
    ...
    9:  (VET, [EXA, POR]),
    10: (VET, [NUM, EXE, EXT]),
    11: (TEN, ["1-formas: por que elas existem", "A base dual"]),
    ...
    17: (FLU, ["Densidade é um fluxo temporal",
               "1-formas, superfícies e o fluxo invariante",
               "Conservação do número de partículas"]),
    18: (FLU, ["O tensor energia-momento", "Tensões e a simetria do tensor"]),
    19: (FLU, ["Fluidos gerais: energia interna e a primeira lei",
               "Conservação de energia e momento", "O fluido perfeito",
