...
\definecolor{codekeyword}{rgb}{0.0,0.35,0.55}
...
\lstdefinelanguage{Mathematica}{
  morekeywords={Simplify,FullSimplify,Solve,DSolve,NDSolve,Table,Plot,Manipulate,
    Module,Block,With,If,For,Do,Sum,Integrate,D,Grad,Series,MatrixForm,
    Transpose,Inverse,Det,Eigenvalues,Cosh,Sinh,Tanh,Sqrt,ArcTanh},
  sensitive=true,
  morecomment=[l]{(*}{*)},
  morestring=[b]",
}
...
\newtcolorbox{numerico}{
  colback=purple!4!white,
  colframe=purple!45!black,
  title=Resolução numérica,
  fonttitle=\bfseries,
  breakable
}
...
\begin{numerico}
\lstinputlisting[style=python]{codigo/cap02_boosts.py}
\end{numerico}
...
\begin{numerico}
\lstinputlisting[style=python]{codigo/cap02_tempo_proprio.py}
\end{numerico}
...
\begin{numerico}
\lstinputlisting[style=mathematica]{codigo/cap02_boosts.wl}
\end{numerico}
...
\begin{numerico}
\lstinputlisting[style=python]{codigo/cap03_quadrivetores.py}
\end{numerico}
...
\begin{numerico}
\lstinputlisting[style=python]{codigo/cap03_compton_foguete.py}
\end{numerico}

\subsection{Mathematica}

\begin{numerico}
\lstinputlisting[style=mathematica]{codigo/cap03_quadrivetores.wl}
\end{numerico}
...
\[
  V=V^ie_i\quad\text{(regra do paralelogramo)},
  \qquad
  V_i=V\cdot e_i\quad\text{(projeção perpendicular sobre cada eixo)}.
\]
...
\begin{numerico}
\lstinputlisting[style=python]{codigo/cap04_tensores.py}
\end{numerico}
...
\begin{numerico}
\lstinputlisting[style=mathematica]{codigo/cap04_tensores.wl}
\end{numerico}
